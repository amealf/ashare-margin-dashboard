...
def plot_overlay(data: pd.DataFrame, output_png: Path) -> None:
    ...
    ax1.set_title("A股融资余额与中证500、创业板指走势叠加（2014-01至今）", fontsize=16, pad=16)
    ax1.set_xlabel("日期")
    ax1.set_ylabel("融资余额（万亿元）", color="#1f77b4")
    ...
    note = (
        f"融资余额最新：{meta['latestMarginDate']}，{meta['latestMargin']:.2f}万亿元；"
